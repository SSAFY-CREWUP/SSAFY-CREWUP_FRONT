...
import { Plus, MapLocation, Filter, Sort } from '@element-plus/icons-vue'
...
<template>
  <div class="course-list-view">
    ...
    <div class="course-grid" v-loading="loading">
      ...
      <div v-else v-for="course in courseStore.courses" :key="course.id" class="course-card" @click="openDetail(course)">
